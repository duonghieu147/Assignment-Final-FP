    ...
    <div className={open ? "navbar navbar--small" : "navbar"}>
      <div className="navbar__header" onClick={openSideBar}>
        ...
        <div className="navbar__header__content small--hide">
          ...
          <span className="navbar__header__content__desc">Palo Alto, CA</span>
        </div>
      </div>
        ...
        <ul className="navbar__list">
          <li className="navbar__item">
            <NavLink to="/" exact className="navbar__link">
              ...
              <span className="navbar__link__text small--hide">Dashboard</span>
            </NavLink>
          </li>
          <li className="navbar__item">
            <NavLink to="/app" exact className="navbar__link ">
              <Icon.IconApp className="navbar__link__icon" />

              <span className="navbar__link__text small--hide">Apps</span>
            </NavLink>
          </li>
          <li className="navbar__item">
            <NavLink to="/security" exact className="navbar__link ">
              <Icon.Security className="navbar__link__icon" />

              <span className="navbar__link__text small--hide">Securiry</span>
          ...
          <li className="navbar__item">
            <NavLink to="/report" exact className="navbar__link">
              ...
              <span className="navbar__link__text small--hide">Reports</span>
            </NavLink>
          </li>
          <li className="navbar__item">
            <NavLink to="/people" exact className="navbar__link ">
              <Icon.People className="navbar__link__icon" />
              <span className="navbar__link__text small--hide">People</span>
            </NavLink>
          </li>
          <li className="navbar__item">
            <NavLink to="/task" exact className="navbar__link ">
              <Icon.Task className="navbar__link__icon" />
              <span className="navbar__link__text small--hide">Tasks</span>
            </NavLink>
          </li>
          <li className="navbar__item">
            <NavLink to="/chat" exact className="navbar__link">
              ...
              <span className="navbar__link__text small--hide">Chat</span>
              <span className="navbar__link__number small--hide">453</span>
            </NavLink>
          </li>
        </ul>
      </div>
        ...
        <ul className="navbar__list">
          <li className="navbar__item">
            <NavLink to="/gallery" exact className="navbar__link">
              ...
              <span className="navbar__link__text small--hide">Gallery</span>
            </NavLink>
          </li>

          <li className="navbar__item">
            <NavLink to="/workflows" exact className="navbar__link ">
              <Icon.Device className="navbar__link__icon" />
              <span className="navbar__link__text small--hide">Workflows</span>
            </NavLink>
          </li>
          ...
          <li className="navbar__item">
            <NavLink to="/my-task" exact className="navbar__link">
              ...
              <span className="navbar__link__text small--hide">My Tasks</span>
            </NavLink>
          </li>
        </ul>
      </div>
      ...
      <div className="navbar__group">
        ...
        <ul className="navbar__list">
          <li className="navbar__item">
            <NavLink to="/intergration" exact className="navbar__link ">
          ...
          <li className="navbar__item">
            <NavLink to="/user" exact className="navbar__link ">
              <Icon.Group className="navbar__link__icon" />
              <span className="navbar__link__text small--hide">Users</span>
            </NavLink>
          </li>

          <li className="navbar__item">
            <NavLink to="/setting" exact className="navbar__link ">
              <Icon.Setting className="navbar__link__icon" />
              <span className="navbar__link__text small--hide">Settings</span>
            </NavLink>
          </li>
        </ul>
      </div>
